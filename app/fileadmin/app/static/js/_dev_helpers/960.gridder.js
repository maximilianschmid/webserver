...
function Grid(){
    ...
    c.createGrid = function(){
        ...
        jQuery('<div id="g-grid" style="display:none;"></div>').appendTo("body").css("width", c.settings.size);
